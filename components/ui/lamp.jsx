    ...
    (<div
      ...
      <div
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, width: "70vw" }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible max-w-[30rem] bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]">
          <div
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 max-w-[30rem] bg-gradient-conic from-transparent via-transparent to-cyan-500 text-white [--conic-position:from_290deg_at_center_top]">
          <div
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 max-w-64 -translate-y-[6rem] rounded-full bg-cyan-400 blur-2xl"></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 max-w-[30rem] -translate-y-[7rem] bg-cyan-400"></motion.div>
